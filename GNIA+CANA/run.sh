...
# ogbn-products
nohup python -u run_gnia_cana.py --dataset ogbproducts --suffix  --batchsize 128 --alpha 0.5 --beta 0.01 --Dopt 10 --lr_G 1e-3 --lr_D 1e-3 --gpu 6 > logs/ogbproducts.log 2>&1 &
