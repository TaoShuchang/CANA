...
def eval_robustness(model, features, adj, target_idx, labels, device, args, run):
    ...
    if "speit" in args.eval_attack.lower():
        ...
        attacker = SEQGIA(epsilon=args.attack_lr,
                 ...
                 hinge=args.hinge)
    elif args.eval_attack.lower() in ["pgd","rpgd"]:
...
'''
CUDA_VISIBLE_DEVICES=2  nohup python -u gnn_misg.py --dataset 'grb-cora'  --inductive --eval_robo --eval_attack 'pgd' --n_inject_max 60 --n_edge_max 20 --grb_mode 'full' --runs 1 --disguise_coe 0  --use_ln 0 > log/cora_pgd.log 2>&1 & 

nohup python -u gnn_misg.py --dataset 'grb-cora'  --inductive --eval_robo --eval_attack 'rpgd' --n_inject_max 60 --n_edge_max 20 --grb_mode 'full' --runs 1 --disguise_coe 1 --use_ln 0 > log/cora_hao_pgd.log 2>&1 & 

CUDA_VISIBLE_DEVICES=3  nohup python -u gnn_misg.py --dataset 'grb-cora'  --inductive --eval_robo  --eval_attack rtdgia --model 'gcn' --eval_robo_blk --use_ln 0 --m 100 --attack 'flag' > log/flag_cora_hao_tdgia.log 2>&1 &

nohup python -u gnn_misg.py --dataset 'grb-cora'  --inductive --eval_robo --eval_attack rpgd  --model 'robustgcn' --eval_robo_blk  --use_ln 0 > log/rgcn_cora_hao_pgd.log 2>&1 &


nohup python -u gnn_misg.py --dataset 'grb-cora'  --inductive --eval_robo --eval_attack 'pgd'  --model 'gnnguardor' --eval_robo_blk --layer_norm_first --use_ln 0 > log/guard_cora_pgd.log 2>&1 &
'''