...
def main(args):
    ...
    graph_save_file = get_filelist(graphpath, [], name='_d200')
    ...
    # single_file.append('../../PGD_DINA/new_graphs/ogbproducts/alpha10_bs2099.npz')
    # single_file.append('../../PGD_DINA/new_graphs/ogbproducts/alpha10_bs2099_260.npz')
    # single_file.append('../../PGD_DINA/new_graphs/reddit/alpha20_Dopt20.npz')
    # single_file.append('../../PGD_DINA/new_graphs/reddit/alpha20_Dopt20_120.npz')
    # single_file.append('../../PGD_DINA/new_graphs/reddit/alpha20_init5_lrG-1_120.npz')
    # single_file.append('../../PGD_DINA/new_graphs/reddit/alpha100_lrG-1_Dopt5.npz')
    # single_file.append('../../PGD_DINA/new_graphs/reddit/alpha100_lrG-1_Dopt5_200.npz')
    # single_file.append('../../PGD_DINA/new_graphs/ogbarxiv/alpha50_lrG-3.npz')
    # single_file.append('../../PGD_DINA/new_graphs/ogbarxiv/alpha50_lrG-3_60.npz')
    ...
    # single_file.append('../../GNIA_DINA/new_graphs/' + args.dataset + '/multi_full_alpha2_lr-4_Dopt20_clip.npz' )
    # single_file.append('../../GNIA_DINA/new_graphs/' + args.dataset + '/multi_full_alpha2_lr-4_Dopt20_multi_clip.npz' )
    # single_file.append('../../TDGIA_DINA/new_graphs/prestruc/ogbproducts/alpha10_Dopt100_lr0.01_120.npz')
    # single_file.append('../../TDGIA_DINA/new_graphs/prestruc/ogbproducts/alpha10_Dopt100_lr0.01_140.npz')
    # single_file.append('../../TDGIA_DINA/new_graphs/prestruc/ogbproducts/alpha10_Dopt100_lr0.01_160.npz')
    # single_file.append('../../TDGIA_DINA/new_graphs/prestruc/ogbproducts/alpha10_Dopt100_lr0.01_180.npz')

    # single_file.append('../../TDGIA_DINA/new_graphs/prestruc/ogbproducts/30inj_alpha10_lr-2_Dopt100_bs3200_600.npz')
    # single_file.append('../../TDGIA_DINA/new_graphs/prestruc/ogbproducts/30inj_alpha10_lr-2_Dopt100_bs3200_620.npz')
    # single_file.append('../../TDGIA_DINA/new_graphs/prestruc/ogbproducts/30inj_alpha10_lr-2_Dopt100_bs3200_640.npz')
    # single_file.append('../../TDGIA_DINA/new_graphs/prestruc/ogbproducts/30inj_alpha10_lr-2_Dopt100_bs3200_740.npz')
    
   
    # single_file.append('../../PGD_DINA/new_graphs/ogbproducts/30inj_alpha10_bs2099_260.npz')
    # single_file.append('../../PGD_DINA/new_graphs/ogbproducts/30inj_alpha10_bs2099_280.npz')
    # single_file.append('../../PGD_DINA/new_graphs/ogbproducts/30inj_alpha10_bs2099_300.npz')
    # single_file.append('../../PGD_DINA/new_graphs/ogbproducts/30inj_alpha10_bs2099_320.npz')
    # single_file.append('../../PGD_DINA/new_graphs/ogbproducts/30inj_alpha10_bs2099_340.npz')
...
'''
hao
nohup python -u eval_classifier_new.py --suffix tdgia+hao_d  --gpu 4 --dataset ogbproducts >> log/ogbproducts/tdgia+hao_d.log 2>&1 &
nohup python -u eval_classifier_new.py --suffix tdgia+hao_d  --gpu 3 --dataset reddit > log/reddit/tdgia+hao_d.log 2>&1 &
nohup python -u eval_classifier_new.py --suffix tdgia+hao_d  --gpu 2 --dataset ogbarxiv > log/ogbarxiv/tdgia+hao_d.log 2>&1 &



nohup python -u eval_classifier_new.py --suffix tdgia_adima30inj_bs  --gpu 4 --dataset ogbproducts > log/ogbproducts/tdgia_adima30inj_bs.log 2>&1 &

nohup python -u eval_classifier_new.py --suffix pgd_adima_30inj  --gpu 4 --dataset ogbproducts > log/ogbproducts/30inj.log 2>&1 &
nohup python -u eval_classifier_new.py  --gpu 2 --dataset reddit > log/reddit/origraph.log 2>&1 &
nohup python -u eval_classifier_new.py --gpu 1 --dataset ogbarxiv >> log/ogbarxiv/gnia_dina_full_multi.log 2>&1 &
nohup python -u eval_classifier_new.py  --gpu 4 --dataset ogbarxiv > log/ogbarxiv/tdgia_dina.log 2>&1 &
nohup python -u eval_classifier_new.py  --gpu 5 --dataset ogbarxiv > log/ogbarxiv/gnia_dina_full.log 2>&1 &

nohup python -u eval_classifier_new.py  --gpu 2 --dataset ogbproducts > log/ogbproducts/30inj.log 2>&1 &
